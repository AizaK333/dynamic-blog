...
import { FaFacebook, FaLinkedin } from 'react-icons/fa'; // Icons for social media
    ...
    <nav className="bg-black text-white shadow-md sticky top-0 z-20 border-b border-gray-600">
      <div className="max-w-6xl mx-auto px-6 sm:px-12 flex justify-between items-center py-4">
        ...
        <div className="text-2xl font-bold">
            ...
            <span className="text-purple-600">AN</span><span className="text-white">Blogs</span>
        ...
        <div className="flex space-x-6 ml-auto">
          <Link href="https://www.linkedin.com/in/aiza-nadeem-7339b127b/" target="_blank" className="hover:text-purple-600 transition duration-300">
            <FaLinkedin className="w-6 h-6" />
          </Link>
          <Link href="https://www.facebook.com" target="_blank" className="hover:text-purple-600 transition duration-300">
      ...
      <div className={`sm:hidden ${isMobileMenuOpen ? 'block' : 'hidden'} bg-black text-white py-4`}>
        <div className="flex flex-col items-center space-y-4">
          <Link href="/" className="text-lg hover:text-purple-600 transition duration-300" onClick={toggleMobileMenu}>Home</Link>
          <Link href="/about" className="text-lg hover:text-purple-600 transition duration-300" onClick={toggleMobileMenu}>About</Link>
        </div>
      </div>
    </nav>
  );
