      ...
      <main className="max-w-6xl mx-auto p-6">
        <section id="home">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post) => (
              <div key={post.id} className="bg-black-200 border-2 border-blue-600 text-white p-6 shadow-lg rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:translate-y-2 w-full  hover:border-blue-900 ">
                {/* Post Image */}
                <div className="mb-4">
